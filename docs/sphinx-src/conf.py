...
man_pages = [
    ('manual/manual', 'tizonia', u'A command-line streaming music client/server for Linux with support for Google Play Music, YouTube, TuneIn Internet Radio, Plex servers and Chromecast devices.', [u'Juan A. Rubio'], 1)
]
